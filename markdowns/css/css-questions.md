...
35. [Q35: What are CSS Container Queries and how do they differ from Media Queries?](#q35-what-are-css-container-queries-and-how-do-they-differ-from-media-queries)
36. [Q36: How do you use CSS Custom Properties (Variables) and what are their advantages?](#q36-how-do-you-use-css-custom-properties-variables-and-what-are-their-advantages)
37. [Q37: Explain CSS Grid Layout and how it differs from Flexbox](#q37-explain-css-grid-layout-and-how-it-differs-from-flexbox)
38. [Q38: Explain CSS Animations and Transitions, and when to use each](#q38-explain-css-animations-and-transitions-and-when-to-use-each)
39. [Q39: Explain CSS Flexbox and its key properties](#q39-explain-css-flexbox-and-its-key-properties)
40. [Q40: What are CSS Preprocessors and what advantages do they offer?](#q40-what-are-css-preprocessors-and-what-advantages-do-they-offer)
41. [Q41: What is CSS-in-JS and what are its advantages and disadvantages?](#q41-what-is-css-in-js-and-what-are-its-advantages-and-disadvantages)
42. [Q42: What are CSS Methodologies and how do they help in organizing CSS?](#q42-what-are-css-methodologies-and-how-do-they-help-in-organizing-css)
43. [Q43: How can you optimize CSS for performance?](#q43-how-can-you-optimize-css-for-performance)
44. [Q44: How can you make CSS more accessible?](#q44-how-can-you-make-css-more-accessible)
45. [Q45: What are CSS Variables (Custom Properties)?](#q45-what-are-css-variables-custom-properties)
46. [Q46: Explain `calc()`, `min()`, `max()`, and `clamp()`.](#q46-explain-calc-min-max-and-clamp)
47. [Q47: CSS Grid vs Flexbox: When to use which?](#q47-css-grid-vs-flexbox-when-to-use-which)
48. [Q48: What is CSS Subgrid?](#q48-what-is-css-subgrid)
49. [Q49: What is the `gap` property?](#q49-what-is-the-gap-property)
50. [Q50: What is `aspect-ratio`?](#q50-what-is-aspect-ratio)
51. [Q51: What are Container Queries (`@container`)?](#q51-what-are-container-queries-container)
52. [Q52: Explain new Viewport Units (`dvh`, `svh`, `lvh`).](#q52-explain-new-viewport-units-dvh-svh-lvh)
53. [Q53: `position: sticky` vs `fixed`.](#q53-position-sticky-vs-fixed)
54. [Q54: Explain Stacking Context and `z-index`.](#q54-explain-stacking-context-and-z-index)
55. [Q55: What is Margin Collapse?](#q55-what-is-margin-collapse)
56. [Q56: What is `box-sizing: border-box`?](#q56-what-is-box-sizing-border-box)
57. [Q57: `display: none` vs `visibility: hidden` vs `opacity: 0`.](#q57-display-none-vs-visibility-hidden-vs-opacity-0)
58. [Q58: Pseudo-classes vs Pseudo-elements.](#q58-pseudo-classes-vs-pseudo-elements)
59. [Q59: How do you use `::before` and `::after`?](#q59-how-do-you-use-before-and-after)
60. [Q60: `:nth-child()` vs `:nth-of-type()`.](#q60-nth-child-vs-nth-of-type)
61. [Q61: Explain `:not()`, `:is()`, and `:where()`.](#q61-explain-not-is-and-where)
62. [Q62: What is the `:has()` selector?](#q62-what-is-the-has-selector)
63. [Q63: `:focus-visible` vs `:focus`.](#q63-focus-visible-vs-focus)
64. [Q64: What is `:focus-within`?](#q64-what-is-focus-within)
65. [Q65: What is `::marker`?](#q65-what-is-marker)
66. [Q66: What is `::selection`?](#q66-what-is-selection)
67. [Q67: What is `::placeholder`?](#q67-what-is-placeholder)
68. [Q68: What are CSS Layers (`@layer`)?](#q68-what-are-css-layers-layer)
69. [Q69: How does Specificity work?](#q69-how-does-specificity-work)
70. [Q70: What is CSS Nesting?](#q70-what-is-css-nesting)
71. [Q71: What is `will-change`?](#q71-what-is-will-change)
72. [Q72: What is `content-visibility`?](#q72-what-is-content-visibility)
73. [Q73: `object-fit` vs `background-size`.](#q73-object-fit-vs-background-size)
74. [Q74: `clip-path` property.](#q74-clip-path-property)
75. [Q75: `mask` vs `clip-path`.](#q75-mask-vs-clip-path)
76. [Q76: `filter` vs `backdrop-filter`.](#q76-filter-vs-backdrop-filter)
77. [Q77: What is `mix-blend-mode`?](#q77-what-is-mix-blend-mode)
78. [Q78: Scroll Snap (`scroll-snap-type`).](#q78-scroll-snap-scroll-snap-type)
79. [Q79: What is `overscroll-behavior`?](#q79-what-is-overscroll-behavior)
80. [Q80: What is `writing-mode`?](#q80-what-is-writing-mode)
81. [Q81: Explain Logical Properties.](#q81-explain-logical-properties)
82. [Q82: What are Variable Fonts?](#q82-what-are-variable-fonts)
83. [Q83: What is `font-display`?](#q83-what-is-font-display)
84. [Q84: What is `line-clamp`?](#q84-what-is-line-clamp)
85. [Q85: `text-wrap: balance` vs `pretty`.](#q85-text-wrap-balance-vs-pretty)
86. [Q86: What is the `ch` unit?](#q86-what-is-the-ch-unit)
87. [Q87: What is `currentColor`?](#q87-what-is-currentcolor)
88. [Q88: What are `@supports` (Feature Queries)?](#q88-what-are-supports-feature-queries)
89. [Q89: How do you handle Dark Mode in CSS?](#q89-how-do-you-handle-dark-mode-in-css)
90. [Q90: What is `prefers-reduced-motion`?](#q90-what-is-prefers-reduced-motion)
91. [Q91: What are CSS Shapes?](#q91-what-are-css-shapes)
92. [Q92: `pointer-events` property.](#q92-pointer-events-property)
93. [Q93: `user-select` property.](#q93-user-select-property)
94. [Q94: `touch-action` property.](#q94-touch-action-property)
95. [Q95: `isolation: isolate`.](#q95-isolation-isolate)
96. [Q96: What are CSS Sprites?](#q96-what-are-css-sprites)
97. [Q97: CSS Reset vs Normalize.](#q97-css-reset-vs-normalize)
98. [Q98: What is the View Transitions API?](#q98-what-is-the-view-transitions-api)
99. [Q99: Scroll-driven Animations.](#q99-scroll-driven-animations)
100. [Q100: How to debug CSS layout issues?](#q100-how-to-debug-css-layout-issues)
---
...
### Q45: What are CSS Variables (Custom Properties)?
**Difficulty: Easy**

**Answer:**
Entities defined by authors that contain specific values to be reused throughout a document. They start with `--` and are accessed using `var()`. They cascade and can be updated via JavaScript.
...
### Q46: Explain `calc()`, `min()`, `max()`, and `clamp()`.
**Difficulty: Medium**

**Answer:**
- **`calc()`:** Performs calculations (e.g., `width: calc(100% - 20px)`).
- **`min()`:** Uses the smallest value from a list.
- **`max()`:** Uses the largest value from a list.
- **`clamp()`:** Clamps a value between an upper and lower bound (`clamp(min, val, max)`). Great for fluid typography.

### Q47: CSS Grid vs Flexbox: When to use which?
**Difficulty: Medium**

**Answer:**
- **Flexbox:** One-dimensional layout (row OR column). Best for aligning items in a single direction or distributing space.
- **Grid:** Two-dimensional layout (rows AND columns). Best for overall page layout and complex structures.

### Q48: What is CSS Subgrid?
**Difficulty: Advanced**

**Answer:**
A value for `grid-template-columns` or `grid-template-rows` (`subgrid`). It allows a nested grid item to inherit the tracks of its parent grid, aligning perfectly with the parent's layout.

### Q49: What is the `gap` property?
**Difficulty: Easy**

**Answer:**
Defines the size of the gutters (spacing) between rows and columns in Grid, Flexbox, and Multi-column layouts. Replaces older hacks with margins.

### Q50: What is `aspect-ratio`?
**Difficulty: Easy**
...
### Q51: What are Container Queries (`@container`)?
**Difficulty: Advanced**

**Answer:**
Allows styles to be applied to an element based on the size of its **container** rather than the viewport. This is a game-changer for component-based design.
...
### Q52: Explain new Viewport Units (`dvh`, `svh`, `lvh`).
**Difficulty: Medium**

**Answer:**
To handle dynamic mobile browser toolbars:
- **`svh` (Small Viewport Height):** Height when UI bars are expanded (smallest visible area).
- **`lvh` (Large Viewport Height):** Height when UI bars are retracted (largest visible area).
- **`dvh` (Dynamic Viewport Height):** Dynamically adjusts between svh and lvh.

### Q53: `position: sticky` vs `fixed`.
**Difficulty: Medium**

**Answer:**
- **`fixed`:** Positioned relative to the viewport. Stays in place when scrolling.
- **`sticky`:** Toggles between `relative` and `fixed` depending on the scroll position. It sticks to its nearest scrolling ancestor.

### Q54: Explain Stacking Context and `z-index`.
**Difficulty: Advanced**

**Answer:**
`z-index` only works on positioned elements (not static). A Stacking Context is a 3D conceptualization of HTML elements along an imaginary z-axis. Elements are stacked based on their context, not just the global page. Properties like `opacity < 1`, `transform`, `filter`, and `isolation: isolate` create new stacking contexts.

### Q55: What is Margin Collapse?
**Difficulty: Medium**

**Answer:**
When the vertical margins of two adjacent elements are combined into a single margin whose size is the larger of the two individual margins. Happens between siblings and parent/child (if no border/padding separates them).

### Q56: What is `box-sizing: border-box`?
**Difficulty: Easy**

**Answer:**
It includes padding and border in the element's total width and height. This makes sizing elements much more intuitive.

### Q57: `display: none` vs `visibility: hidden` vs `opacity: 0`.
**Difficulty: Easy**

**Answer:**
- **`display: none`:** Removes element from the render tree. No space occupied. Not focusable.
- **`visibility: hidden`:** Hides element but occupies space. Not focusable.
- **`opacity: 0`:** Transparent but occupies space. Still interactive and focusable.

### Q58: Pseudo-classes vs Pseudo-elements.
**Difficulty: Easy**

**Answer:**
- **Pseudo-classes (`:hover`):** Define a special state of an element.
- **Pseudo-elements (`::before`):** Style specified parts of an element or insert content.

### Q59: How do you use `::before` and `::after`?
**Difficulty: Medium**

**Answer:**
They create a pseudo-element that is the first or last child of the selected element. Requires the `content` property to be visible.
...
### Q60: `:nth-child()` vs `:nth-of-type()`.
**Difficulty: Medium**

**Answer:**
- **`:nth-child(n)`:** Matches the nth child regardless of type.
- **`:nth-of-type(n)`:** Matches the nth child of that specific tag type.

### Q61: Explain `:not()`, `:is()`, and `:where()`.
**Difficulty: Advanced**

**Answer:**
- **`:not()`:** Negation pseudo-class.
- **`:is()`:** Matches any of the selectors in the list. Takes the specificity of the most specific selector.
- **`:where()`:** Same as `:is()`, but always has **0 specificity**. Great for resets.

### Q62: What is the `:has()` selector?
**Difficulty: Advanced**

**Answer:**
The "Parent Selector". It selects an element if it contains a certain child.
```css
div:has(img) { border: 1px solid red; } /* Selects div only if it contains an img */
```

### Q63: `:focus-visible` vs `:focus`.
**Difficulty: Medium**

**Answer:**
- **`:focus`:** Applies whenever an element has focus (click or keyboard).
- **`:focus-visible`:** Applies only when the browser determines focus should be visible (e.g., keyboard navigation), avoiding outline on mouse clicks for buttons.

### Q64: What is `:focus-within`?
**Difficulty: Medium**

**Answer:**
Selects an element if that element **or any of its descendants** have focus.

### Q65: What is `::marker`?
**Difficulty: Easy**

**Answer:**
Selects the marker box (bullet point or number) of a list item (`<li>` or `display: list-item`). Allows changing color, font, etc.

### Q66: What is `::selection`?
**Difficulty: Easy**

**Answer:**
Applies styles to the portion of a document that has been highlighted (selected) by the user.

### Q67: What is `::placeholder`?
**Difficulty: Easy**

**Answer:**
Styles the placeholder text in `<input>` and `<textarea>` elements.

### Q68: What are CSS Layers (`@layer`)?
**Difficulty: Advanced**

**Answer:**
A mechanism to manage cascade specificity. Styles in a layer defined later override styles in earlier layers, regardless of selector specificity. Helps prevent "specificity wars".

### Q69: How does Specificity work?
**Difficulty: Medium**

**Answer:**
A weight applied to a CSS declaration.
...
### Q70: What is CSS Nesting?
**Difficulty: Medium**

**Answer:**
Native ability to nest CSS rules inside other rules, similar to SCSS/Less.
```css
.card {
  & .title { color: red; }
}
...
### Q71: What is `will-change`?
**Difficulty: Advanced**

**Answer:**
Hints to the browser that an element is expected to change (e.g., `transform`, `opacity`). Allows the browser to optimize (e.g., promote to a new layer) ahead of time. Use sparingly.

### Q72: What is `content-visibility`?
**Difficulty: Advanced**

**Answer:**
Allows the user agent to skip an element's rendering work (layout and painting) until it is needed (e.g., comes into viewport). drastically improves initial load performance. `content-visibility: auto`.

### Q73: `object-fit` vs `background-size`.
**Difficulty: Easy**

**Answer:**
- **`object-fit`:** Controls how the content of a replaced element (`<img>`, `<video>`) fits into its box.
- **`background-size`:** Controls how a background image fits into its container.

### Q74: `clip-path` property.
**Difficulty: Medium**

**Answer:**
Creates a clipping region that sets what part of an element should be shown. Parts outside are hidden.
```css
clip-path: polygon(50% 0, 100% 100%, 0 100%); /* Triangle */
```

### Q75: `mask` vs `clip-path`.
**Difficulty: Advanced**

**Answer:**
- **`clip-path`:** Vector-based clipping (hard edges).
- **`mask`:** Image-based masking (alpha channel). Allows for soft edges and gradients transparency.

### Q76: `filter` vs `backdrop-filter`.
**Difficulty: Medium**

**Answer:**
- **`filter`:** Applies effects (blur, grayscale) to the element itself.
- **`backdrop-filter`:** Applies effects to the area **behind** the element (glassmorphism).

### Q77: What is `mix-blend-mode`?
**Difficulty: Advanced**

**Answer:**
Defines how an element's content should blend with the content of the element's parent and the element's background (like Photoshop blending modes: multiply, screen, overlay).

### Q78: Scroll Snap (`scroll-snap-type`).
**Difficulty: Medium**

**Answer:**
Enforces the scroll position to snap to certain points after the user stops scrolling. Great for carousels.
```css
.container { scroll-snap-type: x mandatory; }
.item { scroll-snap-align: start; }
```

### Q79: What is `overscroll-behavior`?
**Difficulty: Medium**

**Answer:**
Controls what happens when you reach the boundary of a scroll area (e.g., preventing the whole page from scrolling when a modal is scrolled to the end). `overscroll-behavior: contain`.

### Q80: What is `writing-mode`?
**Difficulty: Medium**

**Answer:**
Defines whether lines of text are laid out horizontally or vertically and the direction in which blocks progress. Useful for internationalization.

### Q81: Explain Logical Properties.
**Difficulty: Medium**

**Answer:**
Properties that map to physical properties depending on the writing mode (e.g., `margin-inline-start` instead of `margin-left`, `padding-block` instead of `padding-top/bottom`). Essential for multi-language support.

### Q82: What are Variable Fonts?
**Difficulty: Advanced**

**Answer:**
A single font file that behaves like multiple fonts. It contains variations (axes) like weight, width, slant that can be interpolated smoothly.

### Q83: What is `font-display`?
**Difficulty: Medium**

**Answer:**
Determines how a font face is displayed depending on whether and when it is downloaded and ready to use.
- **`swap`:** Fallback text is shown immediately, swaps to custom font when loaded.
- **`block`:** Hides text briefly until font loads.

### Q84: What is `line-clamp`?
**Difficulty: Easy**

**Answer:**
Limits the text to a specified number of lines.
```css
display: -webkit-box;
-webkit-line-clamp: 3;
...
### Q85: `text-wrap: balance` vs `pretty`.
**Difficulty: Medium**

**Answer:**
- **`balance`:** Balances the number of characters on each line (great for headlines).
- **`pretty`:** Prevents orphans (single words on the last line) in paragraphs.

### Q86: What is the `ch` unit?
**Difficulty: Easy**

**Answer:**
Relative unit equal to the width of the "0" (zero) character of the current font. Great for setting readable line lengths (`max-width: 60ch`).

### Q87: What is `currentColor`?
**Difficulty: Easy**

**Answer:**
A keyword that represents the current value of the `color` property of the element. Useful for matching borders or SVGs to text color.

### Q88: What are `@supports` (Feature Queries)?
**Difficulty: Medium**

**Answer:**
Allows you to apply CSS only if the browser supports a specific property/value pair.
```css
@supports (display: grid) { ... }
```

### Q89: How do you handle Dark Mode in CSS?
**Difficulty: Easy**
...
### Q90: What is `prefers-reduced-motion`?
**Difficulty: Medium**

**Answer:**
Media query to detect if the user has requested the system to minimize the amount of animation or motion.
```css
@media (prefers-reduced-motion: reduce) { * { animation: none; } }
```

### Q91: What are CSS Shapes?
**Difficulty: Advanced**

**Answer:**
Allows you to wrap text around a custom shape (like a circle or polygon) instead of a box. Used with `shape-outside` on floated elements.

### Q92: `pointer-events` property.
**Difficulty: Medium**

**Answer:**
Controls under what circumstances a graphic element can become the target of pointer events. `pointer-events: none` makes clicks pass through the element.

### Q93: `user-select` property.
**Difficulty: Easy**

**Answer:**
Controls whether the user can select text. `user-select: none` prevents text selection (useful for UI buttons).

### Q94: `touch-action` property.
**Difficulty: Medium**

**Answer:**
Sets how an element's region can be manipulated by a touchscreen user (e.g., panning, zooming). `touch-action: none` disables browser handling (useful for custom gestures).

### Q95: `isolation: isolate`.
**Difficulty: Advanced**

**Answer:**
Creates a new Stacking Context. Useful to ensure `z-index` works within a component without affecting the rest of the page or to prevent mix-blend-mode from blending with the background.

### Q96: What are CSS Sprites?
**Difficulty: Medium**

**Answer:**
A technique of combining multiple images into a single image file to reduce HTTP requests. Less common now due to HTTP/2 and SVGs.

### Q97: CSS Reset vs Normalize.
**Difficulty: Easy**

**Answer:**
- **Reset:** Strips all browser default styling (start from zero).
- **Normalize:** Preserves useful defaults but makes them consistent across browsers.

### Q98: What is the View Transitions API?
**Difficulty: Advanced**

**Answer:**
A new API that provides a mechanism for easily creating animated transitions between different DOM states (even between pages).

### Q99: Scroll-driven Animations.
**Difficulty: Advanced**

**Answer:**
Linking CSS animations to the scroll position of a scroll container.
```css
animation-timeline: scroll();
```

### Q100: How to debug CSS layout issues?
**Difficulty: Easy**

**Answer:**
- Use browser DevTools (Inspect Element).
- Check computed styles.
- Use `outline: 1px solid red` on elements ("Ghost CSS debugging").
- Check for `overflow`, `width`, and `height` constraints.
- Verify `z-index` and stacking contexts.
