...
- [Q31: What is the difference between `npm`, `yarn`, and `pnpm`?](#q31-what-is-the-difference-between-npm-yarn-and-pnpm)
- [Q32: Explain Semantic Versioning (SemVer) in Node.js](#q32-explain-semantic-versioning-semver-in-nodejs)
- [Q33: What is the purpose of `package-lock.json`?](#q33-what-is-the-purpose-of-package-lockjson)
- [Q34: What is middleware in Express.js?](#q34-what-is-middleware-in-expressjs)
- [Q35: How do you handle errors in Express.js?](#q35-how-do-you-handle-errors-in-expressjs)
- [Q36: What is `body-parser` and why is it needed?](#q36-what-is-body-parser-and-why-is-it-needed)
- [Q37: How do you serve static files in Express.js?](#q37-how-do-you-serve-static-files-in-expressjs)
- [Q38: What are template engines and which ones are popular in Node.js?](#q38-what-are-template-engines-and-which-ones-are-popular-in-nodejs)
- [Q39: What are the best practices for designing a REST API in Node.js?](#q39-what-are-the-best-practices-for-designing-a-rest-api-in-nodejs)
- [Q40: What is the difference between authentication and authorization?](#q40-what-is-the-difference-between-authentication-and-authorization)
- [Q41: Compare JWT (JSON Web Tokens) and Session-based authentication](#q41-compare-jwt-json-web-tokens-and-session-based-authentication)
- [Q42: What is Passport.js and how does it work?](#q42-what-is-passportjs-and-how-does-it-work)
- [Q43: What is CORS and how do you handle it in Node.js?](#q43-what-is-cors-and-how-do-you-handle-it-in-nodejs)
- [Q44: What is Helmet.js and why should you use it?](#q44-what-is-helmetjs-and-why-should-you-use-it)
- [Q45: How do you implement logging in a Node.js application?](#q45-how-do-you-implement-logging-in-a-nodejs-application)
- [Q46: How do you manage environment variables in Node.js?](#q46-how-do-you-manage-environment-variables-in-nodejs)
- [Q47: How do you connect Node.js to a MongoDB database using Mongoose?](#q47-how-do-you-connect-nodejs-to-a-mongodb-database-using-mongoose)
- [Q48: What are Mongoose Schemas and Models?](#q48-what-are-mongoose-schemas-and-models)
- [Q49: Explain the MongoDB Aggregation Pipeline](#q49-explain-the-mongodb-aggregation-pipeline)
- [Q50: When should you use SQL vs. NoSQL with Node.js?](#q50-when-should-you-use-sql-vs-nosql-with-nodejs)
- [Q51: What is Redis and how is it used in Node.js applications?](#q51-what-is-redis-and-how-is-it-used-in-nodejs-applications)
- [Q52: How do you implement a message queue in Node.js?](#q52-how-do-you-implement-a-message-queue-in-nodejs)
- [Q53: How do you use WebSockets in Node.js?](#q53-how-do-you-use-websockets-in-nodejs)
- [Q54: What are the popular testing frameworks for Node.js?](#q54-what-are-the-popular-testing-frameworks-for-nodejs)
- [Q55: How do you mock dependencies in Node.js tests?](#q55-how-do-you-mock-dependencies-in-nodejs-tests)
- [Q56: What is code coverage and how do you measure it?](#q56-what-is-code-coverage-and-how-do-you-measure-it)
- [Q57: How do you debug a Node.js application?](#q57-how-do-you-debug-a-nodejs-application)
- [Q58: How do you profile a Node.js application for performance?](#q58-how-do-you-profile-a-nodejs-application-for-performance)
- [Q59: How do you detect and fix memory leaks in Node.js?](#q59-how-do-you-detect-and-fix-memory-leaks-in-nodejs)
- [Q60: What is PM2 and why should you use it?](#q60-what-is-pm2-and-why-should-you-use-it)
- [Q61: What is Server-Side Rendering (SSR) and how does it differ from Client-Side Rendering (CSR)?](#q61-what-is-server-side-rendering-ssr-and-how-does-it-differ-from-client-side-rendering-csr)
- [Q62: How do you implement SSR in Node.js?](#q62-how-do-you-implement-ssr-in-nodejs)
- [Q63: What is the purpose of `package.json` scripts?](#q63-what-is-the-purpose-of-packagejson-scripts)
- [Q64: What is the `cluster` module in Node.js?](#q64-what-is-the-cluster-module-in-nodejs)
- [Q65: How do you handle file uploads in Node.js?](#q65-how-do-you-handle-file-uploads-in-nodejs)
- [Q66: What is streams backpressure?](#q66-what-is-streams-backpressure)
- [Q67: What is the `zlib` module used for?](#q67-what-is-the-zlib-module-used-for)
- [Q68: How do you secure a Node.js application against XSS attacks?](#q68-how-do-you-secure-a-nodejs-application-against-xss-attacks)
- [Q69: How do you secure a Node.js application against SQL/NoSQL injection?](#q69-how-do-you-secure-a-nodejs-application-against-sql-nosql-injection)
- [Q70: What is CSRF and how do you prevent it?](#q70-what-is-csrf-and-how-do-you-prevent-it)
- [Q71: Explain the concept of "Error-First Callback"](#q71-explain-the-concept-of-error-first-callback)
- [Q72: What is `promisify` in Node.js?](#q72-what-is-promisify-in-nodejs)
- [Q73: What is the difference between `fork()` and `spawn()`?](#q73-what-is-the-difference-between-fork-and-spawn)
- [Q74: What is `exec()` and `execFile()`?](#q74-what-is-exec-and-execfile)
- [Q75: How do you handle graceful shutdown in Node.js?](#q75-how-do-you-handle-graceful-shutdown-in-nodejs)
- [Q76: What is a reverse proxy and why use Nginx with Node.js?](#q76-what-is-a-reverse-proxy-and-why-use-nginx-with-nodejs)
- [Q77: How do you implement rate limiting in Node.js?](#q77-how-do-you-implement-rate-limiting-in-nodejs)
- [Q78: What is the difference between `require` and `import` (CommonJS vs ES Modules)?](#q78-what-is-the-difference-between-require-and-import-commonjs-vs-es-modules)
- [Q79: How do you use ES Modules in Node.js?](#q79-how-do-you-use-es-modules-in-nodejs)
- [Q80: What is the purpose of the `global` object in Node.js?](#q80-what-is-the-purpose-of-the-global-object-in-nodejs)
- [Q81: What is `process.env`?](#q81-what-is-processenv)
- [Q82: How do you read command line arguments in Node.js?](#q82-how-do-you-read-command-line-arguments-in-nodejs)
- [Q83: What is the `util` module?](#q83-what-is-the-util-module)
- [Q84: What is the `path` module and why should you use it?](#q84-what-is-the-path-module-and-why-should-you-use-it)
- [Q85: What is the `fs` module? Difference between sync and async methods](#q85-what-is-the-fs-module-difference-between-sync-and-async-methods)
- [Q86: How do you watch for file changes in Node.js?](#q86-how-do-you-watch-for-file-changes-in-nodejs)
- [Q87: What is `__dirname` and `__filename`?](#q87-what-is-__dirname-and-__filename)
- [Q88: What is the difference between `exports` and `module.exports`?](#q88-what-is-the-difference-between-exports-and-moduleexports)
- [Q89: How do you create a custom CLI tool with Node.js?](#q89-how-do-you-create-a-custom-cli-tool-with-nodejs)
- [Q90: What is `npm link` and when do you use it?](#q90-what-is-npm-link-and-when-do-you-use-it)
- [Q91: What is `npx`?](#q91-what-is-npx)
- [Q92: How do you publish a package to npm?](#q92-how-do-you-publish-a-package-to-npm)
- [Q93: What is the purpose of `.npmignore`?](#q93-what-is-the-purpose-of-npmignore)
- [Q94: What is GraphQL and how does it compare to REST in Node.js?](#q94-what-is-graphql-and-how-does-it-compare-to-rest-in-nodejs)
- [Q95: How do you implement GraphQL in Node.js?](#q95-how-do-you-implement-graphql-in-nodejs)
- [Q96: What are Microservices and how do you implement them in Node.js?](#q96-what-are-microservices-and-how-do-you-implement-them-in-nodejs)
- [Q97: What is gRPC and when should you use it?](#q97-what-is-grpc-and-when-should-you-use-it)
- [Q98: What is Docker and how do you containerize a Node.js app?](#q98-what-is-docker-and-how-do-you-containerize-a-nodejs-app)
- [Q99: How do you optimize a Dockerfile for Node.js?](#q99-how-do-you-optimize-a-dockerfile-for-nodejs)
- [Q100: What are the latest features in Node.js (e.g., Node 20/22)?](#q100-what-are-the-latest-features-in-nodejs-eg-node-2022)
...
setInterval(() => {
  ...
  console.log(
    `   Memory RSS: ${(stats.memoryUsage.rss / 1024 / 1024).toFixed(2)}MB`
  );
...
async function demonstrateBestPractices() {
  ...
  const results = await Promise.all(operations.map((op) => processor(op)));
  console.log(
    `   Rate-limited processing (20 ops, max 5 concurrent): ${
      Date.now() - start3
    }ms`
  );
...
async function updateInventory(productId, quantity) {
  ...
  console.log(
    `Updating inventory for product ${productId}, reducing by ${quantity}`
  );
...
const proxyOptions = {
  ...
  onProxyReq: (proxyReq, req, res) => {
    ...
    // Log proxy request
    console.log(
      `[${req.headers["x-correlation-id"]}] Proxying to ${proxyReq.path}`
    );
  },
  onError: (err, req, res) => {
...
app.use(
  "/api/users",
  authenticate,
  createProxyMiddleware({ ...proxyOptions, target: SERVICES.users })
);
app.use(
  "/api/orders",
  authenticate,
  createProxyMiddleware({ ...proxyOptions, target: SERVICES.orders })
);
app.use(
  "/api/products",
  createProxyMiddleware({ ...proxyOptions, target: SERVICES.products })
);
...
class CircuitBreaker {
  ...
  async executeRequest(serviceName, requestFn) {
    ...
    if (service.state === "OPEN") {
      ...
      if (Date.now() - service.lastFailureTime > this.resetTimeout) {
        console.log(
          `Circuit for ${serviceName} transitioning from OPEN to HALF-OPEN`
        );
  ...
  handleSuccess(serviceName) {
    ...
    if (service.state === "HALF-OPEN") {
      ...
      if (service.successCount >= this.successThreshold) {
        console.log(
          `Circuit for ${serviceName} transitioning from HALF-OPEN to CLOSED`
        );
  ...
  handleFailure(serviceName, error) {
    ...
    if (
      ...
      console.log(
        `Circuit for ${serviceName} transitioning from CLOSED to OPEN`
      );
      service.state = "OPEN";
    } else if (service.state === "HALF-OPEN") {
      console.log(
        `Circuit for ${serviceName} transitioning from HALF-OPEN to OPEN`
      );
      service.state = "OPEN";
    }
          ...
          return {
            async *[Symbol.asyncIterator]() {
              ...
              for await (const value of asyncIterator) {
                if (
                  value.commentCreated.postId.toString() === postId.toString()
                ) {
                  yield value;
                }
              }
...
async function startApolloServer() {
  ...
  const typeDefs = [baseTypeDefs, authTypeDefs, subscriptionTypeDefs];
...
function startCpuProfiling(duration = 30000) {
  ...
  setTimeout(() => {
    ...
    fs.writeFileSync(
      `./profiles/${profileName}.cpuprofile`,
...
setInterval(() => {
  serviceHealth.uptime = Math.floor(
    (Date.now() - serviceHealth.startTime) / 1000
  );
}, 1000);
...
app.get("/health/ready", async (req, res) => {
  try {
    ...
    const allChecksOk = Object.values(serviceHealth.checks).every(
...
sourceFile.pipe(gzipStream).pipe(destinationFile);
...
async function copyFileWithThrottling(source, destination) {
  ...
  readStream.on("data", (chunk) => {
    ...
    if (!canContinue) {
      backpressureCount++;
      console.log(
        `Backpressure detected (${backpressureCount} times), pausing read stream`
      );
      readStream.pause();
  ...
  writeStream.on("finish", () => {
    console.log(
      `File copied to ${destination} with ${backpressureCount} backpressure events`
    );
  });
...
objectStream.pipe(transformer).pipe(objectLogger);
```
...
class DataTransformer extends Transform {
  ...
  _flush(callback) {
    console.log(
      `Processed ${this.totalRows} rows, ${this.passedRows} passed the filter`
    );
    callback();
  }
}
...
const server = http.createServer((req, res) => {
  if (req.method === "POST" && req.url === "/upload") {
    ...
    req.pipe(progressStream).pipe(fileStream);
  ...
  connect() {
    ...
    return new Promise((resolve, reject) => {
      ...
      setTimeout(() => {
        ...
        console.log(
          `Connected to database with connection id: ${this.connection.id}`
        );
...
module.exports = {
  ...
  async authenticateUser(username, password) {
    ...
    const mockHash = crypto
      .pbkdf2Sync(password, mockSalt, 1000, 64, "sha512")
      .toString("hex");
...
class UserRepository {
  ...
  async findByEmail(email) {
    ...
    return this.db.query(
      `SELECT * FROM ${this.collection} WHERE email = '${email}'`
    );
  }
...
class OrderRepository {
  ...
  async findByUserId(userId) {
    await this.db.connect();
    return this.db.query(
      `SELECT * FROM ${this.collection} WHERE userId = ${userId}`
    );
  }
...
async function main() {
  ...
  const order = await orderRepo.create({
    userId: user.id,
    products: [{ id: "prod1", quantity: 2, price: 29.99 }],
    total: 59.98,
  });
...
container.factory(
  "notificationService",
  (c) => new NotificationService(c.get("emailService"))
);
container.factory(
  "userService",
  (c) => new UserService(c.get("userRepository"), c.get("notificationService"))
);
...
class CryptoStrategy extends PaymentStrategy {
  ...
  async processPayment(amount, currency) {
    console.log(
      `Processing ${this.cryptoCurrency} payment equivalent to ${amount} ${currency}`
    );
...
async function main() {
  ...
  processor.setStrategy(
    new CreditCardStrategy("4111111111111111", "John Doe", "12/2025", "123")
  );
  ...
  processor.setStrategy(
    new PayPalStrategy("john.doe@example.com", "password123")
  );
  ...
  processor.setStrategy(
    new CryptoStrategy("0x1234567890abcdef1234567890abcdef12345678", "ETH")
  );
...
class CachingApiServiceProxy {
  constructor(apiService, ttlMs = 60000) {
  ...
  async validate(request) {
    ...
    for (const [field, expectedType] of Object.entries(this.fieldTypes)) {
      if (field in request) {
        ...
        if (!valid) {
          throw new Error(
            `Validation failed: Field '${field}' should be of type '${expectedType}'`
          );
        }
      }
    }
      ...
      if (field in request) {
        ...
        if (typeof value === "number") {
          if (range.min !== undefined && value < range.min) {
            throw new Error(
              `Validation failed: Field '${field}' should be at least ${range.min}`
            );
          }

          if (range.max !== undefined && value > range.max) {
            throw new Error(
              `Validation failed: Field '${field}' should be at most ${range.max}`
            );
          }
        } else if (typeof value === "string") {
          if (range.minLength !== undefined && value.length < range.minLength) {
            throw new Error(
              `Validation failed: Field '${field}' should have at least ${range.minLength} characters`
            );
          }

          if (range.maxLength !== undefined && value.length > range.maxLength) {
            throw new Error(
              `Validation failed: Field '${field}' should have at most ${range.maxLength} characters`
            );
          }
        } else if (Array.isArray(value)) {
          if (range.minItems !== undefined && value.length < range.minItems) {
            throw new Error(
              `Validation failed: Field '${field}' should have at least ${range.minItems} items`
            );
          }

          if (range.maxItems !== undefined && value.length > range.maxItems) {
            throw new Error(
              `Validation failed: Field '${field}' should have at most ${range.maxItems} items`
            );
          }
        }
      }
...
class SocketIOServer {
  ...
  async handlePrivateMessage(socket, data) {
    ...
    console.log(
      `Private message from ${socket.username} to user ${targetUserId}`
    );
  }
...
class SecureApp {
  ...
  requestLogger(req, res, next) {
    ...
    res.on("finish", () => {
      ...
      if (res.statusCode >= 400) {
        console.warn(
          `Suspicious request: ${req.method} ${req.url} - ${res.statusCode} - IP: ${req.ip}`
        );
      }
    });
...
class APIGateway {
  ...
  setupRoutes() {
    ...
    this.app.use(
      "/api/users",
      this.createServiceProxy("user-service", "/api/users")
    );

    // Order service routes
    this.app.use(
      "/api/orders",
      this.createServiceProxy("order-service", "/api/orders")
    );

    // Product service routes
    this.app.use(
      "/api/products",
      this.createServiceProxy("product-service", "/api/products")
    );

    // Payment service routes
    this.app.use(
      "/api/payments",
      this.createServiceProxy("payment-service", "/api/payments")
    );

    // Notification service routes
    this.app.use(
      "/api/notifications",
      this.createServiceProxy("notification-service", "/api/notifications")
    );
  ...
  createServiceProxy(serviceName, pathRewrite) {
    ...
    return httpProxy({
      ...
      router: async (req) => {
        try {
          const service = await this.serviceDiscovery.getServiceInstance(
            serviceName
          );
  ...
  startWorker() {
    ...
    app.get("/cpu-intensive", async (req, res) => {
      ...
      try {
        ...
        const result = await this.performCPUIntensiveTask(
          req.query.iterations || 1000000
        );
    ...
    const server = app.listen(process.env.PORT || 3000, () => {
      console.log(
        `🔧 Worker ${process.pid} started on port ${server.address().port}`
      );
...
if (cluster.isMaster) {
    ...
    async executeTask(taskType, taskData) {
      return new Promise((resolve, reject) => {
        if (this.activeThreads >= this.maxThreads) {
          ...
          this.executeSyncTask(taskData).then(resolve).catch(reject);
          return;
        }

        this.executeInThread(taskType, taskData).then(resolve).catch(reject);
      });
    }
  ...
  app.get("/hybrid-task", async (req, res) => {
    try {
      ...
      const result = await taskManager.executeTask("cpu-intensive", {
        iterations,
      });
...
class APIVersionManager {
  ...
  deprecateVersion(version, sunsetDate) {
    ...
    console.log(
      `API version ${version} deprecated. Sunset date: ${sunsetDate}`
    );
  }
  ...
  versionMiddleware() {
    return (req, res, next) => {
      ...
      if (this.deprecatedVersions.has(resolvedVersion)) {
        res.set(
          "Warning",
          `299 - "API version ${resolvedVersion} is deprecated"`
        );
...
class ErrorMonitor {
  ...
  monitorError(error, context = {}) {
    ...
    this.errorCounts.set(
      errorKey,
      errorTimes.filter((time) => time > threshold)
    );
  ...
  async sendEmailAlert(severity, message, details) {
    const mailOptions = {
      ...
      html: `
        ...
        ${
          details.context
            ? `<h3>Context:</h3><pre>${JSON.stringify(
                details.context,
                null,
                2
              )}</pre>`
...
class SocketServer {
  ...
  async handleSendMessage(
    socket,
    { roomId, message, type = "text", metadata = {} }
  ) {
    // Validate message
    if (!message || message.trim().length === 0) {
      throw new Error("Message cannot be empty");
  ...
  async processFile(fileInfo, fileData) {
    /* Implementation */
  }
...
**Answer:**
Advanced patterns help in building scalable and maintainable applications.

- **Layered Architecture**: Controller -> Service -> Data Access (DAO/Repository).
- **Dependency Injection**: Inverting control to make modules testable (e.g., using libraries like `InversifyJS` or NestJS built-in DI).
- **CQRS (Command Query Responsibility Segregation)**: Separating read and write operations.
- **Microservices**: Breaking monolithic apps into smaller services.
- **Adapter Pattern**: To interface with different third-party services.
...
- **Phase**: Executes in the **next tick queue**, which is processed _immediately_ after the current operation completes and _before_ the event loop proceeds to the next phase (e.g., timers, I/O).
...
4. The current script finishes, and Node.js processes the next tick queue _before_ moving to the next event loop phase. This is why `process.nextTick callback` is logged first.
...
- Use `process.nextTick()` when you need to execute a callback _before_ the event loop continues. Be cautious with recursion, as it can block the event loop.
...
### Q31: What is the difference between `npm`, `yarn`, and `pnpm`?

**Difficulty: Easy**

**Answer:**
These are all package managers for Node.js, used to manage dependencies.

1.  **npm (Node Package Manager)**: The default package manager that comes with Node.js. It installs packages sequentially and stores them in a flat `node_modules` structure (since v3).
2.  **Yarn**: Created by Facebook to address performance and security issues in npm. It introduced parallel installation, offline mode, and deterministic dependency resolution via `yarn.lock`.
3.  **pnpm (Performant npm)**: Uses a content-addressable storage system. It saves disk space by storing all packages in a single global store and creating hard links in the project's `node_modules`. It is generally faster and more disk-efficient than npm and Yarn.

### Q32: Explain Semantic Versioning (SemVer) in Node.js.

**Difficulty: Easy**

**Answer:**
Semantic Versioning is a versioning scheme using the format `MAJOR.MINOR.PATCH` (e.g., `1.4.2`).
...
- `^1.2.3`: Updates to the latest minor/patch version (e.g., `<2.0.0`).
- `~1.2.3`: Updates to the latest patch version (e.g., `<1.3.0`).
- `1.2.3`: Exact version only.

### Q33: What is the purpose of `package-lock.json`?

**Difficulty: Easy**

**Answer:**
`package-lock.json` is automatically generated when you modify `node_modules` or `package.json`. It describes the exact tree that was generated, such that subsequent installs are able to generate identical trees, regardless of intermediate dependency updates. This ensures consistent environments across development, staging, and production.
...
### Q35: How do you handle errors in Express.js?

**Difficulty: Medium**

**Answer:**
Express comes with a default error handler, but you can define custom error-handling middleware. Error-handling middleware functions are defined in the same way as other middleware functions, except they have four arguments instead of three: `(err, req, res, next)`.
...
### Q36: What is `body-parser` and why is it needed?

**Difficulty: Easy**

**Answer:**
`body-parser` is a middleware that parses incoming request bodies in a middleware before your handlers, available under the `req.body` property. Before Express 4.16.0, it was a separate package. Now, it's built-in as `express.json()` and `express.urlencoded()`.
...
### Q37: How do you serve static files in Express.js?
...
// Now files in 'public' directory are accessible directly: http://localhost:3000/images/kitten.jpg
```

### Q38: What are template engines and which ones are popular in Node.js?
...
- **Handlebars**: Logic-less templates using `{{}}` syntax.

### Q39: What are the best practices for designing a REST API in Node.js?
...
2.  **Use HTTP Status Codes**: 200 OK, 201 Created, 400 Bad Request, 401 Unauthorized, 404 Not Found, 500 Server Error.
3.  **Resource Naming**: Use plural nouns for resources (e.g., `/users`, not `/getUser`).
4.  **Versioning**: Version your API (e.g., `/api/v1/users`).
5.  **Pagination, Filtering, Sorting**: Implement these for collection endpoints.
6.  **Security**: Use HTTPS, validate input, implement rate limiting.
7.  **Documentation**: Use tools like Swagger/OpenAPI.
...
- **Authentication (AuthN)**: Verifying **who** a user is (e.g., login with username/password).
- **Authorization (AuthZ)**: Verifying **what** a user has access to (e.g., permissions, roles).

In a Node.js app, you first authenticate the user (e.g., issue a JWT), and then authorize their requests (e.g., check if the JWT has the 'admin' role).

### Q41: Compare JWT (JSON Web Tokens) and Session-based authentication.
...
- **Session-based**:
  - Server creates a session and stores it (memory/database).
  - Server sends a `session_id` cookie to the client.
  - Client sends the cookie with every request.
  - Stateful: Server must look up the session.
  - Harder to scale horizontally (requires sticky sessions or distributed store like Redis).
- **JWT-based**:
  - Server creates a signed token containing user data (payload).
  - Server sends the token to the client.
  - Client sends the token (usually in `Authorization` header).
  - Stateless: Server verifies signature; no lookup needed.
  - Easier to scale horizontally.

### Q42: What is Passport.js and how does it work?

**Difficulty: Medium**

**Answer:**
Passport is authentication middleware for Node.js. It is extremely flexible and modular.

- **Strategies**: Passport uses "strategies" to authenticate requests. Strategies range from verifying a username and password, delegated authentication using OAuth (e.g., via Facebook, Twitter), or federated authentication using OpenID.
- **Usage**: You configure a strategy (e.g., `passport-local`), initialize Passport, and use `passport.authenticate()` middleware on your routes.

### Q43: What is CORS and how do you handle it in Node.js?
...
In Node.js (Express), you handle it using the `cors` middleware:
...
You can also configure it to allow specific origins:
...
### Q44: What is Helmet.js and why should you use it?
...
**Answer:**
For production apps, `console.log` is not enough. You should use a logging library like **Winston** or **Morgan** (for HTTP request logging).
...
**Winston**:
Allows logging to multiple transports (console, file, remote server) with different log levels.

### Q46: How do you manage environment variables in Node.js?

**Difficulty: Easy**

**Answer:**
Environment variables separate configuration from code. The standard way is using the `dotenv` package.
...
### Q47: How do you connect Node.js to a MongoDB database using Mongoose?
...
### Q48: What are Mongoose Schemas and Models?
...
### Q49: Explain the MongoDB Aggregation Pipeline.
...
- `$group`: Group documents by a specific key (like `GROUP BY`).
- `$sort`: Sort documents.
...
### Q50: When should you use SQL vs. NoSQL with Node.js?
...
- **SQL (PostgreSQL, MySQL)**:
  ...
  - ACID transactions are critical (e.g., banking).
- **NoSQL (MongoDB, Redis)**:
  - Unstructured or semi-structured data.
  - Rapidly changing schema.
  - High write throughput.
  - Horizontal scalability is a priority.
  - Data is naturally document-based (JSON-like).

---

## Advanced Topics & Tooling

### Q51: What is Redis and how is it used in Node.js applications?

**Difficulty: Medium**

**Answer:**
Redis is an in-memory data structure store, used as a database, cache, and message broker. In Node.js, it's commonly used for:

1.  **Caching**: Storing API responses to reduce database load.
2.  **Session Store**: Storing user sessions.
3.  **Pub/Sub**: Real-time messaging.
4.  **Queues**: Managing background jobs (e.g., with Bull).

### Q52: How do you implement a message queue in Node.js?

**Difficulty: Advanced**

**Answer:**
Message queues (like RabbitMQ, Kafka, or Redis-based queues) decouple parts of your application.
A common library for Redis-based queues is **Bull**.
...
### Q53: How do you use WebSockets in Node.js?

**Difficulty: Medium**

**Answer:**
WebSockets allow full-duplex communication. **Socket.io** is the most popular library.
...
### Q54: What are the popular testing frameworks for Node.js?

**Difficulty: Easy**

**Answer:**

- **Jest**: All-in-one framework (runner, assertion, mocking). Developed by Facebook. Zero-config.
- **Mocha**: Flexible test runner. Needs external assertion libraries (like Chai) and mocking (like Sinon).
- **Chai**: Assertion library (expect, should, assert).
- **Supertest**: For testing HTTP endpoints.

### Q55: How do you mock dependencies in Node.js tests?

**Difficulty: Medium**

**Answer:**
Mocking allows you to isolate the code under test.
Using **Jest**:
...
test("should use mocked data", () => {
  db.getData.mockReturnValue({ id: 1 });
  // ...
});
```

### Q56: What is code coverage and how do you measure it?

**Difficulty: Medium**

**Answer:**
Code coverage measures the percentage of code executed during tests. It helps identify untested paths.
With **Jest**, simply run: `jest --coverage`.
It generates a report showing statement, branch, function, and line coverage.

### Q57: How do you debug a Node.js application?
...
2.  **Node Inspector**: Run `node --inspect index.js`. Connect via Chrome DevTools (`chrome://inspect`).
3.  **VS Code Debugger**: Built-in support. Set breakpoints, inspect variables, step through code.
4.  **`debugger` keyword**: Pauses execution if inspector is connected.

### Q58: How do you profile a Node.js application for performance?

**Difficulty: Advanced**

**Answer:**

1.  **Node.js Profiler**: `node --prof app.js`. Generates a tick file. Process it with `node --prof-process isolate-*.log`.
2.  **Clinic.js**: A suite of tools (`clinic doctor`, `clinic flame`, `clinic bubbleprof`) to diagnose performance issues.
3.  **Chrome DevTools**: Connect via `--inspect` and use the "Performance" tab to record CPU profiles.

### Q59: How do you detect and fix memory leaks in Node.js?
...
- Heap snapshots using Chrome DevTools. Compare snapshots taken at different times.
...
**Fix**: Identify the retaining path in the heap snapshot and break the reference.

### Q60: What is PM2 and why should you use it?
...
- **Process Management**: Keep apps alive (restart on crash).
- **Cluster Mode**: Utilize all CPU cores (`pm2 start app.js -i max`).
- **Monitoring**: View resource usage (`pm2 monit`).
- **Log Management**: Aggregate logs.
- **Startup Script**: Auto-start on system boot.

### Q61: What is Server-Side Rendering (SSR) and how does it differ from Client-Side Rendering (CSR)?

**Difficulty: Medium**

**Answer:**

- **SSR**: The server renders the full HTML page and sends it to the client.
  - **Pros**: Better SEO, faster First Contentful Paint (FCP).
  - **Cons**: Higher server load, slower Time to First Byte (TTFB).
- **CSR**: The server sends a barebones HTML and a JS bundle. The browser executes JS to render content.
  - **Pros**: Rich interactions, reduced server load.
  - **Cons**: Poor SEO (without crawler optimization), slower initial load.

### Q62: How do you implement SSR in Node.js?

**Difficulty: Advanced**

**Answer:**
You can use template engines (Pug, EJS) for simple SSR. For React/Vue/Angular, you use their specific server-side rendering APIs (e.g., `ReactDOMServer.renderToString()`).
Frameworks like **Next.js** (React) and **Nuxt.js** (Vue) make SSR easy.

### Q63: What is the purpose of `package.json` scripts?

**Difficulty: Easy**

**Answer:**
Scripts allow you to define common commands for your project.
...
Run them with `npm run <script-name>` (e.g., `npm run dev`). `npm start` and `npm test` are special and don't require `run`.

### Q64: What is the `cluster` module in Node.js?

**Difficulty: Medium**

**Answer:**
Node.js is single-threaded. The `cluster` module allows you to create child processes (workers) that share the same server port. This enables you to take advantage of multi-core systems.
...
### Q65: How do you handle file uploads in Node.js?

**Difficulty: Medium**

**Answer:**
You need middleware to handle `multipart/form-data`. **Multer** is the most popular choice.
...
### Q66: What is streams backpressure?

**Difficulty: Hard**

**Answer:**
Backpressure occurs when the data source (Readable stream) produces data faster than the consumer (Writable stream) can process it. This can lead to excessive memory usage.
**Solution**: `pipe()` automatically handles backpressure. It pauses the readable stream when the writable stream buffer is full and resumes it when the buffer drains.

### Q67: What is the `zlib` module used for?

**Difficulty: Medium**

**Answer:**
The `zlib` module provides compression functionality (Gzip, Deflate/Inflate, Brotli). It is often used to compress HTTP responses to reduce bandwidth.
...
### Q68: How do you secure a Node.js application against XSS attacks?
...
1.  **Sanitize Input**: Use libraries like `dompurify` or `xss-clean`.
2.  **Escape Output**: Template engines (Pug, EJS) auto-escape variables by default.
3.  **CSP Headers**: Use Helmet to set Content-Security-Policy.

### Q69: How do you secure a Node.js application against SQL/NoSQL injection?

**Difficulty: Medium**

**Answer:**
**Injection**: Attackers insert malicious queries to manipulate the database.
**Prevention**:

1.  **Use ORMs/ODMs**: Mongoose, Sequelize, TypeORM use parameterized queries or sanitized inputs by default.
2.  **Parameterized Queries**: If using raw SQL, _always_ use placeholders (`?` or `$1`). Never concatenate strings.
3.  **Input Validation**: Validate types and formats (e.g., using Joi/Zod).

### Q70: What is CSRF and how do you prevent it?

**Difficulty: Medium**

**Answer:**
**CSRF (Cross-Site Request Forgery)**: Attackers trick a user into performing actions they didn't intend while authenticated.
**Prevention**:

1.  **CSRF Tokens**: Generate a unique token for each session/request and verify it on the server. Use `csurf` middleware.
2.  **SameSite Cookie Attribute**: Set `SameSite: Strict` or `Lax` on cookies.

### Q71: Explain the concept of "Error-First Callback".

**Difficulty: Easy**

**Answer:**
It's a pattern where the first argument of the callback function is reserved for an error object. If an error occurred, it is passed there; otherwise, it is `null` or `undefined`.
...
### Q72: What is `promisify` in Node.js?

**Difficulty: Easy**

**Answer:**
`util.promisify` converts a callback-based function (following the error-first pattern) into a function that returns a Promise.
...
### Q73: What is the difference between `fork()` and `spawn()`?

**Difficulty: Medium**

**Answer:**
Both are from the `child_process` module.

- **`spawn()`**: Launches a command in a new process. Returns a stream (stdout/stderr). Used for running system commands.
- **`fork()`**: Specifically used to spawn new Node.js processes. It establishes an IPC (Inter-Process Communication) channel between parent and child, allowing message passing (`send()` / `on('message')`).

### Q74: What is `exec()` and `execFile()`?

**Difficulty: Medium**

**Answer:**

- **`exec()`**: Spawns a shell and runs a command within that shell. Buffers the output (has a max buffer size). Good for short commands.
- **`execFile()`**: Similar to `exec()`, but executes the file directly without spawning a shell. Slightly more efficient.

### Q75: How do you handle graceful shutdown in Node.js?

**Difficulty: Medium**

**Answer:**
Graceful shutdown ensures that the server stops accepting new connections but finishes processing existing ones before exiting.
...
### Q76: What is a reverse proxy and why use Nginx with Node.js?

**Difficulty: Medium**

**Answer:**
A reverse proxy sits in front of your web server. Nginx is often used with Node.js to:

1.  **Load Balancing**: Distribute traffic across multiple Node.js processes.
2.  **Static Files**: Serve static assets faster than Node.js.
3.  **SSL/TLS Termination**: Handle encryption/decryption.
4.  **Security**: Hide backend topology.
5.  **Caching**: Cache responses.

### Q77: How do you implement rate limiting in Node.js?

**Difficulty: Medium**

**Answer:**
Rate limiting prevents abuse (DoS attacks, brute force) by limiting the number of requests from an IP.
...
### Q78: What is the difference between `require` and `import` (CommonJS vs ES Modules)?
...
### Q79: How do you use ES Modules in Node.js?
...
### Q80: What is the purpose of the `global` object in Node.js?

**Difficulty: Easy**

**Answer:**
The `global` object provides variables that are available everywhere in the application (like `window` in the browser).
Examples: `console`, `setTimeout`, `process`, `Buffer`.
**Note**: Avoid adding custom variables to `global` as it pollutes the global namespace and makes code hard to test/maintain.

### Q81: What is `process.env`?

**Difficulty: Easy**

**Answer:**
`process.env` is a property on the global `process` object that returns an object containing the user environment. It is commonly used to access environment variables (e.g., `API_KEY`, `DB_HOST`).

### Q82: How do you read command line arguments in Node.js?

**Difficulty: Easy**

**Answer:**
Arguments are stored in `process.argv` (an array).

1.  `process.argv[0]`: Path to Node.js executable.
2.  `process.argv[1]`: Path to the script file.
3.  `process.argv[2]...`: Actual arguments.

Libraries like `yargs` or `commander` make parsing easier.

### Q83: What is the `util` module?

**Difficulty: Easy**

**Answer:**
The `util` module provides utility functions used internally by Node.js but also useful for developers.
Examples: `util.promisify`, `util.inspect` (for debugging objects), `util.types`.

### Q84: What is the `path` module and why should you use it?

**Difficulty: Easy**

**Answer:**
The `path` module provides utilities for working with file and directory paths. You should use it instead of string concatenation to ensure cross-platform compatibility (Windows uses `\` while POSIX uses `/`).

```javascript
const path = require("path");
const fullPath = path.join(__dirname, "public", "image.png");
```

### Q85: What is the `fs` module? Difference between sync and async methods.
...
- **Async (`fs.readFile`)**: Non-blocking. Takes a callback or returns a promise. Recommended for performance.
- **Sync (`fs.readFileSync`)**: Blocking. Halts execution until the operation completes. Use only during startup or scripting.

### Q86: How do you watch for file changes in Node.js?

**Difficulty: Medium**

**Answer:**

- **`fs.watch()` / `fs.watchFile()`**: Native methods (can be inconsistent across platforms).
- **`chokidar`**: A popular wrapper around `fs.watch` that fixes many cross-platform issues. Used by tools like VS Code and Webpack.
- **`nodemon`**: A CLI tool that wraps your app and restarts it on file changes.

### Q87: What is `__dirname` and `__filename`?

**Difficulty: Easy**

**Answer:**
These are local variables available in each module (in CommonJS).

- `__dirname`: The directory name of the current module.
- `__filename`: The file name of the current module.
  **Note**: In ES Modules, these are not available; you use `import.meta.url`.

### Q88: What is the difference between `exports` and `module.exports`?
...
- `exports`: A reference (alias) to `module.exports`.
  You can attach properties to `exports` (`exports.add = ...`), but if you reassign `exports` (`exports = ...`), it breaks the link to `module.exports`.

### Q89: How do you create a custom CLI tool with Node.js?

**Difficulty: Medium**

**Answer:**

1.  Add a "bin" field to `package.json`: `"bin": { "my-tool": "./index.js" }`.
2.  Add a shebang at the top of `index.js`: `#!/usr/bin/env node`.
3.  Make the file executable: `chmod +x index.js`.
4.  Link it locally: `npm link`.

### Q90: What is `npm link` and when do you use it?

**Difficulty: Medium**

**Answer:**
`npm link` creates a symlink in the global folder that points to your local package. It allows you to test a package locally in another project without publishing it to npm.
...
**Answer:**
`npx` is a package runner bundled with npm (v5.2+). It allows you to:

1.  Run locally installed binaries without referencing `node_modules/.bin`.
2.  Run packages without installing them globally (e.g., `npx create-react-app my-app`).

### Q92: How do you publish a package to npm?
...
### Q93: What is the purpose of `.npmignore`?

**Difficulty: Easy**

**Answer:**
It specifies which files should be excluded when publishing a package to npm (e.g., tests, docs, source files if you ship a bundle). If `.npmignore` doesn't exist, npm uses `.gitignore`.

### Q94: What is GraphQL and how does it compare to REST in Node.js?
...
- **REST**: Multiple endpoints, over-fetching/under-fetching of data.
- **GraphQL**: Single endpoint (`/graphql`), client requests exactly what it needs.

### Q95: How do you implement GraphQL in Node.js?

**Difficulty: Medium**

**Answer:**
You can use libraries like **Apollo Server** or **express-graphql**.

1.  Define a **Schema** (Types, Queries, Mutations).
2.  Define **Resolvers** (Functions that fetch the data).
...
### Q96: What are Microservices and how do you implement them in Node.js?

**Difficulty: Advanced**

**Answer:**
Microservices architecture breaks an application into small, independent services that communicate over a network (HTTP/gRPC).
Node.js is great for microservices due to its lightweight nature.
**Key components**:
...
### Q97: What is gRPC and when should you use it?

**Difficulty: Advanced**

**Answer:**
gRPC is a high-performance RPC framework by Google using **Protocol Buffers** (binary format) instead of JSON.
**Use Cases**: Microservices communication (low latency), polyglot environments (strong typing).

### Q98: What is Docker and how do you containerize a Node.js app?

**Difficulty: Medium**

**Answer:**
Docker packages your app and dependencies into a container.
**Dockerfile**:
...
### Q99: How do you optimize a Dockerfile for Node.js?

**Difficulty: Advanced**

**Answer:**

1.  **Use Alpine images**: `node:18-alpine` (smaller size).
2.  **Multi-stage builds**: Separate build dependencies from runtime.
3.  **Cache layers**: Copy `package.json` and install deps _before_ copying source code.
4.  **Production deps**: `npm ci --only=production`.
5.  **User**: Run as non-root user (`USER node`).

### Q100: What are the latest features in Node.js (e.g., Node 20/22)?

**Difficulty: Medium**

**Answer:**

- **Permission Model** (Experimental): Restrict access to file system, child process, etc.
- **Single Executable Applications (SEA)**: Bundle app into a single binary.
- **Stable Test Runner**: Built-in `node:test` module.
- **Watch Mode**: `node --watch`.
- **WebSocket Client**: Built-in experimental WebSocket client.
